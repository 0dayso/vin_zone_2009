...
<div id="DivCtl" style="z-index: 10001; position: absolute; display: none; display: none"
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="120">
        <tr>
            <td>
                <img height="4" src="/MyFramework/Image/CtlPanel/crm_window_01.gif" width="123" />
            </td>
        </tr>
        <tr>
            <td background="/MyFramework/Image/CtlPanel/crm_window_02.gif">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="80%">
                    ...
                    <tr>
                        <td>
                            <div align="center">
                                <img align="absMiddle" height="18" src="/MyFramework/Image/CtlPanel/crm_kzmb_pw.gif"
                                    width="18" /></div>
                        </td>
                        <td>
                            <div align="center">
                                <img align="absMiddle" height="18" src="/MyFramework/Image/CtlPanel/crm_kzmb_dx.gif"
                                    width="18" /></div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <div align="center">
                                <img align="absMiddle" height="18" src="/MyFramework/Image/CtlPanel/crm_kzmb_new.gif"
                                    width="18" /></div>
                        </td>
                        <td>
                            <div align="center">
                                <img align="absMiddle" height="18" src="/MyFramework/Image/CtlPanel/crm_kzmb_gd.gif"
                                    width="18" /></div>
                        </td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td>
                <img height="8" src="/MyFramework/Image/CtlPanel/crm_window_03.gif" width="123" />
            </td>
        </tr>
    </table>
</div>
            ...
            <table height="100%" cellspacing="0" cellpadding="0" width="100%" border="0" bgcolor="#F7FBFF">
                <tr>
                    ...
                    <td valign="top" height="100%" bgcolor="#D4E7EF">
                        <table id="tbcrmleftmenu" style="width: 128px" cellpadding="0" cellspacing="0" border="0"
                            bgcolor="#D4E7EF" align="right">
                            <tr>
                                <td height="20px">
                                </td>
                            </tr>
                    ...
                    <td width="8" valign="top" class="HideBar" background="/MyFramework/Image/GLeftImage/crm_dh_01.gif">
                        <img id="igHideBarImpage" src='/MyFramework/Image/GLeftImage/framehide.gif' border="0"
                            alt="隐藏/显示模块栏" onclick="javascript:hidebar();" width="9" height="31">
                    </td>
                    <%}
                       else
                       {%>
                                        ...
                                        <tr>
                                            <td valign="top" height="100%" align="center">
                                                <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td valign="bottom">
                                                                        <table width="230" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td width="7">
                                                                                    <img src="/MyFramework/Image/GLeftImage/crm_dh_03.gif" width="7" height="28">
                                                                                </td>
                                                                                <td background="/MyFramework/Image/GLeftImage/crm_dh_04.gif">
                                                                                    <div align="center">
                                                                                        <img src="/MyFramework/Image/GLeftImage/dot-dot.jpg" width="13" height="13">&nbsp;<span
                                                                                            class="big_14"><%=this.PageCaption%></span></div>
                                                                                </td>
                                                                                <td width="7">
                                                                                    <img src="/MyFramework/Image/GLeftImage/crm_dh_05.gif" width="12" height="28">
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                    ...
                                                                    <td valign="bottom">
                                                                        <table width="150" border="0" align="right" cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                ...
                                                                                <td valign="middle" width="60">
                                                                                    <a href="<%=this.Toolhref%>" target="_blank">
                                                                                        <%=this.ToolBar%></a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                    ...
                                                    <tr>
                                                        <td height="1" bgcolor="4C7686">
                                                        </td>
                                                    </tr>
                                                    <%} %>
                                                    <tr height="100%">
                                                        <td bgcolor="#ffffff" align="left" valign="top" height="100%" colspan="2">
                                                            <table id="tableContent" cellpadding="4" cellspacing="2" border="0" width="100%" style="min-height:900px; overflow:hidden;"  >
                                                                <tr>
