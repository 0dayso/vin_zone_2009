...
bsCanlendar.prototype.createCalendar=function() {		
    ...
    this.calendarTable.appendChild(this.calendarTableBody);
	  ...
	  calendarTableCells.id=this.calendarID + "HEAD_DECYEAR";
	  ...
	  this.calendarYearSelect.style.fontSize="11px";
	  ...
	  this.calendarMonthSelect.style.fontSize="11px";
	  ...
	  //////////////////////////////////////////////////////
	  var calendarTableCells=document.createElement("TD"); 
	  calendarTableCells.id=this.calendarID + "HEAD_ADDYEAR";
	  calendarTableRows.appendChild(calendarTableCells);
	  calendarTableCells.innerText=">>";
	  calendarTableCells.style.width="13";
	  calendarTableCells.style.cursor="hand";
...
bsCanlendar.prototype.fillCalendar = function() {    
	...
	this.calendarYearSelect.selectedIndex=this.calendarYear-1920;
...
bsCanlendar.prototype.decCalendarMonth=function() {
	if( this.calendarYear == 1920 && this.calendarMonth == 1 ) return;
...
///////////////////////////////////////////////////////////////
bsCanlendar.prototype.decCalendarYear=function() {
    if( this.calendarYear == 1920 && this.calendarMonth == 1 ) return;
    this.calendarYear --;	
	this.setCalendarDate();
	this.fillCalendar();	
}
bsCanlendar.prototype.addCalendarYear=function() {
