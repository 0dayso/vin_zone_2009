<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GroupRows.aspx.cs"
    Inherits="GroupRowsDemo" %>
...
<body>
    <form id="form1" runat="server">
        <div id="DIV1">
            <asp:GridView ID="grvGroupRows" runat="server" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging"
                PageSize="7" OnRowDataBound="GridView1_RowDataBound">
            </asp:GridView>
            <asp:Button ID="btnToXML" runat="server" OnClick="btnToXML_Click" Text="btnToXML" />
        &nbsp;&nbsp;&nbsp; 设置第一列向同行 合并.</div>
        <div>
